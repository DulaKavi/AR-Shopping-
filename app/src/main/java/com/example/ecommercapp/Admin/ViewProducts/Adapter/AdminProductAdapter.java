package com.example.ecommercapp.Admin.ViewProducts.Adapter;
...
public class AdminProductAdapter  extends RecyclerView.Adapter<AdminProductAdapter.ItemViewHolder>{

    List<ProductModel> productModelList;
    Context context;

    public AdminProductAdapter(List<ProductModel> productModelList, Context context) {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate( R.layout.admin_product_card,parent,false) ;
        ...
        viewHolder.card.setOnClickListener(v -> {
            ...
            fragmentTransaction.replace(R.id.admin_container,new AdminProductDescriptionFragment(
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.product_StatusTxt.setText("Status :"+productModelList.get(position).getProductStatus()+"");
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public ItemViewHolder(@NonNull View itemView) {
            ...
            product_StatusTxt =itemView.findViewById(R.id.product_StatusTxt);
