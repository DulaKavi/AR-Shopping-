package com.example.ecommercapp.Admin.ViewProducts;
...
import com.example.ecommercapp.Admin.ViewProducts.Adapter.AdminProductAdapter;
...
public class AdminProductFragment extends Fragment {
    ...
    String TAG="AdminProductFragment";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        rootView=inflater.inflate(R.layout.admin_product, container, false);
    ...
    private void loadData(String searchText) {
        ...
        reference.orderByChild("productName").startAt(searchText.toUpperCase()).endAt(searchText + "\uf8ff").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                AdminProductAdapter adapter= new AdminProductAdapter(productModelList,getContext());
